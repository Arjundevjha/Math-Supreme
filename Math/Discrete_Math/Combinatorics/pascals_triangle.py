...
def generate_pascals_triangle(num_rows: int) -> List[List[int]]:
    ...
    """
    # Security: Strict type checking and upper bound check to prevent DoS / unbounded memory allocation
    ...
    if num_rows > 1000:
        raise ValueError("Number of rows exceeds maximum limit of 1000 to prevent DoS.")
    if num_rows == 0:
        return []
