...
class TestVolumeOfPrism(unittest.TestCase):
    def test_positive_integers(self):
        self.assertEqual(volume_of_prism(10, 5), 50)

    def test_positive_floats(self):
        self.assertAlmostEqual(volume_of_prism(2.5, 4.2), 10.5, places=7)

    def test_mixed_types(self):
        self.assertAlmostEqual(volume_of_prism(3.5, 4), 14.0, places=7)
        self.assertAlmostEqual(volume_of_prism(10, 4.5), 45.0, places=7)
