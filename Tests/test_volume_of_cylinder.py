...
class TestVolumeOfCylinder(unittest.TestCase):
    def test_volume_positive_integers(self):
        # r=2, h=3 -> V = PI * (2**2) * 3 = 12 * PI
        self.assertAlmostEqual(volume_of_cylinder(2, 3), 12 * PI, places=9)

    def test_volume_positive_floats(self):
        # r=1.5, h=2.5 -> V = PI * (1.5**2) * 2.5 = 5.625 * PI
        self.assertAlmostEqual(volume_of_cylinder(1.5, 2.5), 5.625 * PI, places=9)
